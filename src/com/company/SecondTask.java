...
public class SecondTask {
    ...
    public static void main(String[] args) {
        ...
        StringBuffer str_buffer = new StringBuffer(str.subSequence(0, str.length()));  //Замена String на StringBuffer

        System.out.println("Строка с заменой подстрок -> " + str_buffer);
    }
